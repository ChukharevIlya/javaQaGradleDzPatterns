...
public class AppCardDeliveryTest {
    ...
    void shouldSuccessfulPlanAndReplanMeeting() {
        ...
        $x("//*[@data-test-id=\"success-notification\"]//div[contains(text(),\"Встреча успешно запланирована на \")]").should(Condition.visible, Duration.ofSeconds(15)).shouldHave(Condition.exactText("Встреча успешно запланирована на " + firstMeetingDate));
        $x("//*[@data-test-id=\"date\"] //*[@placeholder=\"Дата встречи\"]").doubleClick().sendKeys(Keys.DELETE);
